...
export default function AllCompletedWorkRequirement({ navigation }) {
    ...
    const getCompleteWorkRequirements = async () => {
        try {
            setIsUploading(true);
    ...
    const renderHeader = () => (
        <Animated.View style={[styles.headerContainer, { transform: [{ translateY: headerAnim }] }]}>
            ...
            <View style={styles.topBar}>
                ...
                <Text style={styles.headerTitle}>Completed Work Requirements</Text>
            </View>
        </Animated.View>
    );
