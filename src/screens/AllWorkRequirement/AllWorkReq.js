...
export default function AllWorkRequirement({ navigation }) {
    ...
    const getAllMyWorkRequirements = async () => {
        try {
            setIsUploading(true);
    ...
    const renderHeader = () => (
        <Animated.View style={[styles.headerContainer, { transform: [{ translateY: headerAnim }] }]}>
            ...
            <View style={styles.topBar}>
                ...
                <Text style={styles.headerTitle}>All Work Requirements</Text>
            </View>
        </Animated.View>
    );
