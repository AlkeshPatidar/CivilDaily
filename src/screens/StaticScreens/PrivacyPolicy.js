...
//               setSettings(res?.data?.privacyPolicy)
...
//           <Text style={styles.sectionTitle}>Grocery Privacy</Text>
//           <Text style={styles.sectionContent}>
//             Wagyu beef, originating from Japan, is celebrated for its exceptional marbling, tenderness, and rich flavor. This premium beef, from specific Japanese cattle breeds, features fine streaks of intramuscular fat, creating a melt-in-your-mouth
...
const PrivacyPolicyScreen = ({ navigation }) => {
  ...
  const getSettings = async () => {
    try {
      ...
      const res = await apiGet(`/api/settings`)
      setSettings(res?.data?.privacyPolicy)
      console.log('Privacy Policy Content:', res?.data?.privacyPolicy);
      hideLoader()
    } catch (error) {
        ...
        <View style={styles.section}>
          ...
          {settings === '' && (
            <Text style={styles.errorText}>
              Privacy policy content not available at the moment.
            </Text>
          )}
        ...
        {settings && settings !== '' && (
          <View style={styles.footer}>
            <Text style={styles.footerText}>
              This privacy policy is effective and was last updated recently. 
